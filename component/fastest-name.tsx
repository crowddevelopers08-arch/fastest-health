...
import { Zap, Clock, Award, Thermometer, FileCheck, Shield } from 'lucide-react';
...
const FastestNameSection = () => {
  ...
  return (
    <div className="min-h-screen py-10 px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-white">
      {/* Animated Background Elements */}
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10">
        <div className="absolute top-20 -left-20 w-96 h-96 rounded-full opacity-10 blur-3xl animate-pulse" style={{background: '#135c8e'}}></div>
        <div className="absolute bottom-20 -right-20 w-96 h-96 rounded-full opacity-10 blur-3xl animate-pulse" style={{background: '#d9534f', animationDelay: '1s'}}></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full opacity-5 blur-3xl animate-pulse" style={{background: '#135c8e', animationDelay: '2s'}}></div>
      </div>

      <div className="max-w-7xl mx-auto">
        {/* Headline Section */}
        <div className="text-center mb-16 lg:mb-6 relative">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6 border-2" style={{
            borderColor: '#d9534f',
            background: 'rgba(217, 83, 79, 0.05)'
          }}>
            <Zap className="w-4 h-4" style={{color: '#d9534f'}} />
            <span className="text-sm font-semibold" style={{color: '#d9534f'}}>Industry Leading Speed</span>
          </div>

          {/* Main Headline */}
          <h1 className="text-2xl sm:text-4xl md:text-4xl lg:text-4xl font-extrabold mb-6 lg:mb-2 leading-tight">
        ...
        <div className="text-center relative">
          ...
          <div 
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-32 rounded-full opacity-30 blur-3xl"
            style={{background: '#d9534f'}}
          ></div>

          <button 
            className="relative group px-9 py-3 text-white rounded-full font-bold text-md shadow-2xl transform hover:-translate-y-3 transition-all duration-500 overflow-hidden"
            style={{
