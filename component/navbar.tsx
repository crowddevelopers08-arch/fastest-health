...
//       <div className="container-fluid ml-5 max-sm:ml-0 mr-5 px-4 py-3 max-sm:pl-0 max-sm:py-0">
...
//                     className="w-100 h-40 object-contain max-sm:object-cover"
//                   />
//                 </div>
//               </div>
//             </div>
...
const Navbar = () => {
  ...
  return (
    <nav className="w-full bg-white shadow-lg sticky top-0 z-50">
      {/* Main Navbar Container */}
      <div className="container-fluid ml-5 max-sm:ml-0 mr-5 px-4 py-3 max-sm:px-4 max-sm:py-3">
        <div className="flex flex-col lg:flex-row justify-between items-center gap-4">
          {/* Left Section - Logo & Brand */}
          <div className="flex items-center justify-between w-full lg:w-auto">
            {/* Logo Container */}
